  ...
  <el-dialog
    ...
    <el-row>
      ...
      <el-col :span="8">
        ...
        <span class="text">13419565194</span>
      </el-col>
    </el-row>
    <el-row>
      <h3>订单详情</h3>
      ...
      <el-col :span="8">
        ...
        <span class="text">充电平台</span>
      </el-col>
    </el-row>
    <el-row>
      <h3>用户账户总览</h3>
      <el-col :span="8">
        <span class="label">当前保证金：</span>
        <span class="text">1000元</span>
      </el-col>
      <el-col :span="8">
        <span class="label">历史总缴纳：</span>
        <span class="text">2000元</span>
      </el-col>
      <el-col :span="8">
        <span class="label">历史总退缴：</span>
        <span class="text">1000元</span>
      </el-col>
    </el-row>
    <div class="footer-tip">
      实际转账金额：￥ <b class="money">1000</b> 元
    </div>
